...
Future<bool> canLaunch(String urlString) async {
  ...
  // https://github.com/flutter/flutter/issues/26431
  // ignore: strong_mode_implicit_dynamic_method
  return await _channel.invokeMethod('canLaunch',<String, Object>{'url': urlString},);
}
...
// Dart side.
Future<void> invorksample()async{ 
...
/*
static const MethodChannel channel = const MethodChannel('com_aware_flutter_sensor_sample/method');
